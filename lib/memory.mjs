...
export function projectKey(cwd = process.cwd()) {
  ...
  try {
    ...
    // Only Git's explicit "not a repository" result permits plain-directory
    // fallback. Timeouts, permission failures, and broken Git metadata are
    // identity-verification failures and must remain fail closed.
